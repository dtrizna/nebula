#!/usr/bin/python
''' 
All credits to the authors of the original ember project:
https://github.com/elastic/ember
As well as the authors of the original ember paper:
* Anderson and Roth, 2018: https://arxiv.org/abs/1804.04637

I just ported this file here to avoid legacy 'lief' issues -- 
specific versions of 'ember' and 'lief' crashed exeution of extractor silently.
...
class ByteEntropyHistogram(FeatureType):
    ...
    def raw_features(self, bytez, lief_binary):
        output = np.zeros((16, 16), dtype=np.int16)
