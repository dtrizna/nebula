...
if __name__ == "__main__":
    ...
    datafolders = {}
    datafolders['nebula'] = os.path.join(out_folder_root, f"nebula_speakeasy_vocab_{VOCAB}_seqlen_{SEQ_LEN}")
    datafolders['neurlux'] = os.path.join(out_folder_root, f"neurlux_speakeasy_vocab_{VOCAB}_seqlen_{SEQ_LEN}")
    datafolders['quovadis'] = os.path.join(out_folder_root, f"quovadis_speakeasy_vocab_{VOCAB}_seqlen_{SEQ_LEN}")
    ...
    _, y_test, y_paths_test = preprocess_nebula_speakeasy(
        ...
        seq_len=SEQ_LEN,
        outfolder=datafolders['nebula'],
        tokenizer_model=os.path.join(datafolders['nebula'], f"tokenizer_{VOCAB}.model"),
    )
